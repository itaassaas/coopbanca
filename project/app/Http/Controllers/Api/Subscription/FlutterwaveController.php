...
class FlutterwaveController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        $redirect_url = route('api.subscription.flutter.notify').'?order_number='.$item_number;
        $payment_plan = "";
     ...
     public function notify(Request $request) {
        ...
        $subscription = UserSubscription::where('subscription_number',$request->order_number)->first();
