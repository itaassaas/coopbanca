...
Route::prefix('user')->group(function() {
    ...
    Route::group(['middleware' => ['otp','banuser']],function () {
      ...
      Route::get('/deposit/stripe-submit', [StripeController::class,'success'])->name('deposit.success');
      ...
      Route::get('/subscription/stripe-success', [SubStripeController::class,'success'])->name('subscription.success');
