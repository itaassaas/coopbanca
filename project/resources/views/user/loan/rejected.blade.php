                                ...
                                <tbody>
                                  @foreach($loans as $key=>$data)
                                      <tr>
                                          ...
                                          <td data-lebel="{{ __('Loan Amount') }}" >{{ showprice($data->loan_amount,$currency) }}</td>
                                          <td data-lebel="{{ __('Per Installment') }}" >{{ showprice($data->per_installment_amount,$currency) }}</td>
                                          <td data-lebel="{{ __('Total Installement') }}" >
                                              <div>
