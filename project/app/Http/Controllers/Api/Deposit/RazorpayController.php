...
class RazorpayController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $notify_url = route('api.deposit.razorpay.notify') . '?deposit_id=' . $deposit->id;
        ...
        $deposit->txnid = $razorpayOrder->id;
        $deposit->save();
    ...
    public function notify(Request $request)
    {
        ...
        $deposit->amount = $deposit->amount / $currency->value;
        $deposit->method = "razorpay";
        $deposit->save();
        $payment_id = $deposit->txnid;
